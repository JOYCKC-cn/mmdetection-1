...
if platform.system() == 'Windows':                                                                                                                                                                                  
        ...
        data_root = './data/graydate/20230523_081855/DatasetId_1841668_1684773664/' 
        data_root = './data/graydate/20230523_133347/DatasetId_1841668_1684816961/'                                                                                                                                                                       
else:                                                                                                                                                                                                               
...
model = dict(
    bbox_head=dict(
        ...
        type='MlvlPointGenerator', offset=0, strides=[8*bbox_scale_factor, 16*bbox_scale_factor, 32*bbox_scale_factor] ),
        bbox_coder=dict(type='DistancePointBBoxCoder', base_sizes=[8*bbox_scale_factor, 16*bbox_scale_factor, 32*bbox_scale_factor] ),
...
visualizer = dict(
    ...
    vis_backends = [
        ...
        init_kwargs={'project': f'rtmdet-tiny-graydate','name':f"{wandb_name}"},)
    ]) # noqa
