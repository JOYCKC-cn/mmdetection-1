...
if platform.system() == 'Windows':                                                                                                                                                                                  
        ...
        data_root = './data/20230511_181415/DatasetId_1822463_1682699165/'                                                                                                                                                                      
else:                                                                                                                                                                                                               
...
/opt/workspace/playgroundvisualizer = dict(
    dict(type='DetLocalVisualizer'),
    vis_backends = [
        dict(type='LocalVisBackend'),
        dict(type='TensorboardVisBackend'), 
        dict(type='WandbVisBackend',
        init_kwargs={'project': f'rtmdet-tiny-palmdate','name':f"{wandb_name}"},)
    ]) # noqa
